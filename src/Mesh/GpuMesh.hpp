...
// ============================================================================
// GpuMesh — GPU mirror of Mesh geometry (no physics state).
// ============================================================================
struct GpuFaces {
...
// ============================================================================
// GpuState<NVAR> — double-buffered physics state on GPU.
...
struct GpuState {
    ...
    // Targeted halo transfers (MPI): only halo rows, not full grid
